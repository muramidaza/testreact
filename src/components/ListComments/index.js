	...
	render() {
		return (
			<div className="listComments">
					...
					<div className="listComments__list">
						{this.props.comments.map((comment, i) => (
							<div className="commentsList__cardComment" key={i}>
								<div>
									<p className="listComments__cardCommentName">
										{comment.name}
									</p>
									<p className="listComments__cardCommentBody">
										{comment.body}
									</p>
									<p className="listComments__cardCommentEmail">
				...
				{this.props.loading && (
					<div className="listComments__loading">
